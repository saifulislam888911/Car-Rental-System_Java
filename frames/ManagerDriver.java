...
public class ManagerDriver extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(command.equals(loadBtn.getText()))
		{
           ...
           {
           	   Driver d = mr.searchDriver(driverIdTF.getText());
           	   if(d!=null)
           	   {
		...
		{
			mr.deleteDriver(driverIdTF.getText());
		...
		{
			String data[][] = mr.getDriverUpdate();
			String head[] = {"Id", "Name", "Salary", "Phone","Join Date", "Licence No"};
